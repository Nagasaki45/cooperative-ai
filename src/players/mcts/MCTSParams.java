...
public class MCTSParams implements ParameterSet {
    ...
    public int heuristic_method = JOINT_BINARY_HEURISTIC;
    ...
    public Map<String, Object[]> getParameterValues() {
        ...
        parameterValues.put("heuristic_method", new Integer[]{STUPID_HEURISTIC, SOLO_BINARY_HEURISTIC, JOINT_BINARY_HEURISTIC});
